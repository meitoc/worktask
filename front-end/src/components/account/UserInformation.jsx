...
export default function UserInformation() {
    ...
    const [savedRealname, setSavedRealname] = useState(userData?.information?.real_name??"");
    const [savedGender, setSavedGender] = useState(userData?.information?.gender??"Male");
    const [savedBirthday, setSavedBirthday] = useState(userData?.information?.birthday??"");
    const [savedAddress, setSavedAddress] = useState(userData.information?.address??"");

    const [secretBirthday, setSecretBirthday] = useState(userData?.information?.birthday??'');
    ...
    const [realname, setRealname] = useState(userData?.information?.realname??"");
    const [address, setAddress] = useState(userData?.information?.address??"");
    const [gender, setGender] = useState(userData?.information?.gender??"Male");
