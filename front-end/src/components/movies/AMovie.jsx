...
export default function AMovie(prop) {
  ...
  useEffect(()=>{
    ...
    fetch( `http://localhost:8000/redirect/9La81A3m223aawsQ/3/movie/${prop.movie}?language=en-US`, options)
...
<>
  <Helmet>
      <meta property="og:url" content={`http://localhost:8000/movies/${prop.movie}`} />
